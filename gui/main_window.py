...
class MainWindow(QMainWindow):
    ...
    def _update_canvas_info(self):
        ...
        self.status_label.setText("Canvas updated")
...
"""
        ...
        info_text += "\nShortcuts:\n"
        info_text += "  • Delete Key: Remove selected items\n"
        info_text += "  • Mouse Wheel: Zoom in/out\n"
        info_text += "  • Drag: Move blocks or select multiple\n"
        info_text += "  • Click Output→Input: Create connection\n"
